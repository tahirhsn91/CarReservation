(function(){
  ...
  angular.module('app.supervisor')
    .controller('AssignPackageFormCtrl', AssignPackageFormCtrl);

  /* @ngInject */
  function AssignPackageFormCtrl($stateParams, store, assignPackageFactory, appModules, toast, lodash, $state){
    var vm = this;
